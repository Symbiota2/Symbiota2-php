 ...
 * Omoccurrences
 *
 * @ORM\Table(name="omoccurrences", uniqueConstraints={@ORM\UniqueConstraint(name="Index_collid", columns={"collid", "dbpk"})}, indexes={@ORM\Index(name="Index_sciname", columns={"sciname"}), @ORM\Index(name="Index_family", columns={"family"}), @ORM\Index(name="Index_country", columns={"country"}), @ORM\Index(name="Index_state", columns={"stateProvince"}), @ORM\Index(name="Index_county", columns={"county"}), @ORM\Index(name="Index_collector", columns={"recordedBy"}), @ORM\Index(name="Index_gui", columns={"occurrenceID"}), @ORM\Index(name="Index_ownerInst", columns={"ownerInstitutionCode"}), @ORM\Index(name="FK_omoccurrences_tid", columns={"tidinterpreted"}), @ORM\Index(name="FK_omoccurrences_uid", columns={"observeruid"}), @ORM\Index(name="Index_municipality", columns={"municipality"}), @ORM\Index(name="Index_collnum", columns={"recordNumber"}), @ORM\Index(name="Index_catalognumber", columns={"catalogNumber"}), @ORM\Index(name="Index_eventDate", columns={"eventDate"}), @ORM\Index(name="Index_occurrences_procstatus", columns={"processingstatus"}), @ORM\Index(name="occelevmax", columns={"maximumElevationInMeters"}), @ORM\Index(name="occelevmin", columns={"minimumElevationInMeters"}), @ORM\Index(name="Index_occurrences_cult", columns={"cultivationStatus"}), @ORM\Index(name="Index_occurrences_typestatus", columns={"typeStatus"}), @ORM\Index(name="Index_occurDateLastModifed", columns={"dateLastModified"}), @ORM\Index(name="Index_occurDateEntered", columns={"dateEntered"}), @ORM\Index(name="Index_occurRecordEnteredBy", columns={"recordEnteredBy"}), @ORM\Index(name="Index_locality", columns={"locality"}, flags={"fulltext"}), @ORM\Index(name="Index_otherCatalogNumbers", columns={"otherCatalogNumbers"}), @ORM\Index(name="Index_latestDateCollected", columns={"latestDateCollected"}), @ORM\Index(name="IDX_C48904CFEA1D339B", columns={"collid"})})
 * @ORM\Entity
 */
class Omoccurrences
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="basisOfRecord", type="string", length=32, precision=0, scale=0, nullable=true, options={"default"="PreservedSpecimen","comment"="PreservedSpecimen, LivingSpecimen, HumanObservation"}, unique=false)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="recordNumber", type="string", length=45, precision=0, scale=0, nullable=true, options={"comment"="Collector Number"}, unique=false)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="eventID", type="string", length=45, precision=0, scale=0, nullable=true, unique=false)
     */
    private $eventid;
     ...
     * @var string|null
     *
     * @ORM\Column(name="establishmentMeans", type="string", length=150, precision=0, scale=0, nullable=true, unique=false)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="locationID", type="string", length=100, precision=0, scale=0, nullable=true, unique=false)
     */
    private $locationid;
     ...
     * @var string|null
     *
     * @ORM\Column(name="waterBody", type="string", length=255, precision=0, scale=0, nullable=true, unique=false)
     */
    private $waterbody;
     ...
     * @var int|null
     *
     * @ORM\Column(name="localitySecurity", type="integer", precision=0, scale=0, nullable=true, options={"comment"="0 = no security; 1 = hidden locality"}, unique=false)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="disposition", type="string", length=250, precision=0, scale=0, nullable=true, unique=false)
     */
    private $disposition;
     ...
     * @var string|null
     *
     * @ORM\Column(name="labelProject", type="string", length=250, precision=0, scale=0, nullable=true, unique=false)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="dynamicFields", type="text", length=65535, precision=0, scale=0, nullable=true, unique=false)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="dateEntered", type="datetime", precision=0, scale=0, nullable=true, unique=false)
     */
    private $dateentered;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="dateLastModified", type="datetime", precision=0, scale=0, nullable=false, options={"default"="CURRENT_TIMESTAMP"}, unique=false)
     */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="observeruid", referencedColumnName="uid", nullable=true)
     * })
     */
    private $observeruid;
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entities\Omcollpublications", mappedBy="occid")
     */
    private $pubid;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="App\Entities\Omexsiccatinumbers", mappedBy="occid")
     */
    private $omenid;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="App\Entities\Omoccurduplicates", inversedBy="occid")
     * @ORM\JoinTable(name="omoccurduplicatelink",
     *   joinColumns={
     *     @ORM\JoinColumn(name="occid", referencedColumnName="occid", nullable=true)
     *   },
     *   inverseJoinColumns={
     *     @ORM\JoinColumn(name="duplicateid", referencedColumnName="duplicateid", nullable=true)
     *   }
     * )
     */
    private $duplicateid;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="App\Entities\Paleochronostratigraphy", inversedBy="occid")
     * @ORM\JoinTable(name="omoccurlithostratigraphy",
     *   joinColumns={
     *     @ORM\JoinColumn(name="occid", referencedColumnName="occid", nullable=true)
     *   },
     *   inverseJoinColumns={
     *     @ORM\JoinColumn(name="chronoId", referencedColumnName="chronoId", nullable=true)
     *   }
     * )
     */
    private $chronoid;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="App\Entities\Omoccurloans", mappedBy="occid")
     */
    private $loanid;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="App\Entities\Referenceobject", mappedBy="occid")
     */
    private $refid;
    ...
    {
        $this->pubid = new \Doctrine\Common\Collections\ArrayCollection();
     ...
     * Set observeruid.
     *
     * @param \App\Entities\User|null $observeruid
     *
     * @return Omoccurrences
     */
    public function setObserveruid(\App\Entities\User $observeruid = null)
    {
     ...
     * Add pubid.
     *
     * @param \App\Entities\Omcollpublications $pubid
     *
     * @return Omoccurrences
     */
    public function addPubid(\App\Entities\Omcollpublications $pubid)
    {
        $this->pubid[] = $pubid;
     ...
     */
    public function removePubid(\App\Entities\Omcollpublications $pubid)
    {
        return $this->pubid->removeElement($pubid);
    }
     ...
     * Add omenid.
     *
     * @param \App\Entities\Omexsiccatinumbers $omenid
     *
     * @return Omoccurrences
     */
    public function addOmenid(\App\Entities\Omexsiccatinumbers $omenid)
    {
        $this->omenid[] = $omenid;
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeOmenid(\App\Entities\Omexsiccatinumbers $omenid)
    {
        return $this->omenid->removeElement($omenid);
    }
     ...
     * Add duplicateid.
     *
     * @param \App\Entities\Omoccurduplicates $duplicateid
     *
     * @return Omoccurrences
     */
    public function addDuplicateid(\App\Entities\Omoccurduplicates $duplicateid)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeDuplicateid(\App\Entities\Omoccurduplicates $duplicateid)
    {
        return $this->duplicateid->removeElement($duplicateid);
    }
     ...
     * Add chronoid.
     *
     * @param \App\Entities\Paleochronostratigraphy $chronoid
     *
     * @return Omoccurrences
     */
    public function addChronoid(\App\Entities\Paleochronostratigraphy $chronoid)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeChronoid(\App\Entities\Paleochronostratigraphy $chronoid)
    {
        return $this->chronoid->removeElement($chronoid);
    }
     ...
     * Add loanid.
     *
     * @param \App\Entities\Omoccurloans $loanid
     *
     * @return Omoccurrences
     */
    public function addLoanid(\App\Entities\Omoccurloans $loanid)
    {
        $this->loanid[] = $loanid;
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeLoanid(\App\Entities\Omoccurloans $loanid)
    {
        return $this->loanid->removeElement($loanid);
    }
