...
import { omcollectionsService } from "../omcollections.service";
...
export class CollectionsListData {
  ...
  constructor(private omcollectionsService: omcollectionsService) {
    this.initialize(this.omcollectionsService.getCollections());
  }
