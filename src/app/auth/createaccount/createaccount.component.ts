...
export class CreateaccountComponent implements OnInit {
  ...
  ngOnInit() {
    this.createaccountForm = new FormGroup({
      'login': new FormControl(null, [Validators.required, this.checkLoginSpaces.bind(this)], this.checkLogin.bind(this)),
      'pwd': new FormControl(null, [Validators.required, Validators.minLength(6)]),
      'pwd2': new FormControl(null, [Validators.required, Validators.minLength(6)]),
      'firstname': new FormControl(null, [Validators.required]),
      'middleinitial': new FormControl(null),
      'lastname': new FormControl(null, [Validators.required]),
      'emailaddr': new FormControl(null, [Validators.required, Validators.email], this.checkEmail.bind(this)),
  ...
  checkPasswords(form: FormGroup): {[s: string]: boolean} {
    var pwdControl = form.get('pwd');
    var pwd2Control = form.get('pwd2');
