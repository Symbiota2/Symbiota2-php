 ...
 * @ORM\Entity(repositoryClass="App\Repository\LkupstateprovinceRepository")
 */
class Lkupstateprovince
{
     ...
     * @var \Lkupcountry
     *
     * @ORM\ManyToOne(targetEntity="Lkupcountry")
     * @ORM\JoinColumns({
    ...
    public function getCountryid(): ?Lkupcountry
    {
        return $this->countryid;
    }

    public function setCountryid(?Lkupcountry $countryid): self
    {
