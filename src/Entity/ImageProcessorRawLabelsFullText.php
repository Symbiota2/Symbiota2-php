...
/**
 * ImageProcessorRawLabelsFullText
 *
 ...
 * @ORM\Entity(repositoryClass="App\Repository\ImageProcessorRawLabelsFullTextRepository")
 */
class ImageProcessorRawLabelsFullText
{
    /**
     * @var int
     *
