 ...
 * @ORM\Entity(repositoryClass="App\Repository\OmcollectionsRepository")
 */
class Omcollections
{
    /**
     ...
     *
     * @ORM\ManyToMany(targetEntity="Omcollcategories", mappedBy="collid")
     */
    private $ccpk;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Referenceobject", mappedBy="collid")
     */
    private $refid;
    ...
    /**
     * @return Collection|Omcollcategories[]
     */
    ...
    public function addCcpk(Omcollcategories $ccpk): self
    {
    ...
    public function removeCcpk(Omcollcategories $ccpk): self
    {
        if ($this->ccpk->contains($ccpk)) {
