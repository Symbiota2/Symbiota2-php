 ...
 * @ORM\Entity(repositoryClass="App\Repository\KmcharactersRepository")
 */
class Kmcharacters
{
    /**
     ...
     *
     * @ORM\ManyToMany(targetEntity="Adminlanguages", inversedBy="cid")
    ...
    public function getHid(): ?Kmcharheading
    {
        return $this->hid;
    }

    public function setHid(?Kmcharheading $hid): self
    {
        $this->hid = $hid;
    ...
    /**
     * @return Collection|Adminlanguages[]
     */
    ...
    public function addLangid(Adminlanguages $langid): self
    {
    ...
    public function removeLangid(Adminlanguages $langid): self
    {
        if ($this->langid->contains($langid)) {
