...
namespace OccurrenceAssociation\Entity;
 ...
 * @ORM\Entity()
 * @ApiResource(
 *     routePrefix="/occurrenceassociations",
 *     itemOperations={"get"},
 *     collectionOperations={"get"}
 * )
 */
class Associations implements ModifiedUserIdInterface, CreatedUserIdInterface, InitialTimestampInterface, ModifiedTimestampInterface
{
    /**
     * @var int
     *
