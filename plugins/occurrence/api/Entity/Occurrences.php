...
class Occurrences implements InitialTimestampInterface, ModifiedTimestampInterface
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Occurrence\Entity\Duplicates", inversedBy="occurrenceId")
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Occurrence\Entity\LookupChronostratigraphy", inversedBy="occurrenceId")
    ...
    public function addDuplicateId(Duplicates $duplicateId): self
    {
    ...
    public function removeDuplicateId(Duplicates $duplicateId): self
    {
        if ($this->duplicateId->contains($duplicateId)) {
