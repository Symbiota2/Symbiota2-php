 ...
 * )
 */
class CharacterStates implements InitialTimestampInterface
{
    /**
     * @var int
     *
     ...
     *
     * @ORM\ManyToMany(targetEntity="Key\Entity\Characters", mappedBy="characterStateDependence")
     */
    ...
    public function addCharacterDependence(Characters $characterDependence): self
    {
    ...
    public function removeCharacterDependence(Characters $characterDependence): self
    {
        if ($this->characterDependence->contains($characterDependence)) {
