 ...
 * )
 */
class NlpFragment implements InitialTimestampInterface
{
    /**
     * @var int
     *
    ...
    /**
     * @var \ImageProcessor\Entity\Nlp
     *
     * @ORM\ManyToOne(targetEntity="ImageProcessor\Entity\Nlp")
     * @ORM\JoinColumns({
    ...
    public function getImageProcessorNlpId(): ?Nlp
    {
        return $this->imageProcessorNlpId;
    }

    public function setImageProcessorNlpId(?Nlp $imageProcessorNlpId): self
    {
