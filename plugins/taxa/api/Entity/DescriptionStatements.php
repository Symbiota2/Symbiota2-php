 ...
 * )
 */
class DescriptionStatements implements InitialTimestampInterface
{
    /**
     * @var int
     *
    ...
    /**
     * @var \Taxa\Entity\DescriptionBlock
     *
     * @ORM\ManyToOne(targetEntity="Taxa\Entity\DescriptionBlock")
     * @ORM\JoinColumns({
    ...
    public function getDescriptionBlockId(): ?DescriptionBlock
    {
        return $this->descriptionBlockId;
    }

    public function setDescriptionBlockId(?DescriptionBlock $descriptionBlockId): self
    {
